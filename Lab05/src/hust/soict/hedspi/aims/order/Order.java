...
public class Order {
	...
	public DigitalVideoDisc getALuckyItem() {
		int randomItem = (int)((Math.random())*((this.qtyOrdered-1)+1)+1);
		System.out.println("DVD duoc free: "+itemsOrdered[randomItem-1].getTitle());
		return itemsOrdered[randomItem-1];
	}
}
